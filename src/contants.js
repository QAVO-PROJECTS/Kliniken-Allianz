...
export const TOUR_IMAGES = 'https://api.kliniken-allianz.com/files/tour_images/'
...
export const CAR_CARD_IMAGES = 'https://api.kliniken-allianz.com/files/car/card_images/'
export const CAR_IMAGES = 'https://api.kliniken-allianz.com/files/car/'
export const NEWSPAPER_IMAGES = 'https://api.kliniken-allianz.com/files/newspaper/'