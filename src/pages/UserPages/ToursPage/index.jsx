...
import bannerMobile from "/src/assets/MobileBanner.png"
                ...
                <div className="tours-page">
                    <div className="head">
                        ...
                        <p data-aos="fade-up" data-aos-delay="100">
                            ...
                            <Link to="/tours">{t("toursPage.breadcrumb.tours")}</Link>
                        </p>
                        <div className={'search'}>
                            <input type={'text'}  onChange={(e) => setSearchTerm(e.target.value)}  placeholder={t("toursPage.searchPlaceholder")}/>
                    ...
                    <div className={'headers'}>
                        <h2>{t("toursPage.headerTitle")}</h2>
                        <p>{t("toursPage.headerDesc")}</p>
                    </div>
                    <div className={'cards'}>
                        <div className={'row'}>
