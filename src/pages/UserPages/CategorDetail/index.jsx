...
import {
    ...
    usePostContactMutation, usePostContactServiceMutation
...
function CategoryDetail() {
    ...
    const [postContact] = usePostContactServiceMutation(); // Mutation hook'unu ekledim
                ...
                <div className="contact">
                    ...
                    <div className="row" style={{
                        ...
                        <div className="col-25 col-md-60 col-sm-60 col-xs-60">
                            <div className="image">
                                <img src={image2} alt={t("contact.imageAlt")} />
                            </div>
                        </div>
                    </div>
                </div>
