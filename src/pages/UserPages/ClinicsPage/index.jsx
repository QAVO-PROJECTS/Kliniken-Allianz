                ...
                <div className="clinics-page">
                    <div className="head">
                        ...
                        <div className={'search'}>
                            <input type={'text'} onChange={(e) => setSearchTerm(e.target.value.toLowerCase())} placeholder={t("adminPanel.clinicPage.search.placeholder")}/>
                    ...
                    <div className={'headers'}>
                        <h2>{t("adminPanel.clinicPage.headers.title")}</h2>
                        <p>{t("adminPanel.clinicPage.headers.subtitle")}</p>
                    </div>
                    <div className={'cards'}>
                        <div className={'row'}>
                            {filteredClinics?.length > 0 ? (
                                ...
                                <p style={{ textAlign: "center", width: "100%", marginTop: "20px" }}>
                                    {t("adminPanel.clinicPage.noClinicFound")}
                                </p>
                            )}
                        </div>
                    </div>
